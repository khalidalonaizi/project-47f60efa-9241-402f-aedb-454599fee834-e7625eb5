    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-48">
        <DropdownMenuItem onClick={() => window.open(shareLinks.facebook, '_blank')}>
          <svg className="h-4 w-4 ml-2 text-[#1877F2]" viewBox="0 0 24 24" fill="currentColor">
        ...
        <DropdownMenuItem onClick={() => window.open(shareLinks.whatsapp, '_blank')}>
          <svg className="h-4 w-4 ml-2 text-[#25D366]" viewBox="0 0 24 24" fill="currentColor">
        ...
        <DropdownMenuItem onClick={() => window.open(shareLinks.telegram, '_blank')}>
          <svg className="h-4 w-4 ml-2 text-[#0088CC]" viewBox="0 0 24 24" fill="currentColor">
        ...
        <DropdownMenuItem onClick={() => window.open(shareLinks.linkedin, '_blank')}>
          <svg className="h-4 w-4 ml-2 text-[#0A66C2]" viewBox="0 0 24 24" fill="currentColor">
